...
abstract class _BaseResHelper {
  _BaseResHelper._({
    ...
    this.size,
  })  : mobSSize = mobSSize ?? const Size(360, 640),
        mobMSize = mobMSize ?? const Size(411, 780),
        mobLSize = mobLSize ?? const Size(448, 997),
        tabSSize = tabSSize ?? const Size(800, 1280),
        tabMSize = tabMSize ?? const Size(1024, 1350),
        tabLSize = tabLSize ?? const Size(1280, 1880),
        deskSSize = deskSSize ?? const Size(1500, 740),
        deskMSize = deskMSize ?? const Size(1620, 740),
